...
/*		new/datum/stack_recipe("science airlock assembly", /obj/structure/door_assembly/door_assembly_science, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE), \ */
		...
		new/datum/stack_recipe("yellow multi-tile airlock assembly", /obj/structure/door_assembly/multi_tile/stalker, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE, required_skills = list(/datum/skill/construction = SKILL_LEVEL_PRO)),
		new/datum/stack_recipe("clear multi-tile airlock assembly", /obj/structure/door_assembly/multi_tile/stalker2, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE, required_skills = list(/datum/skill/construction = SKILL_LEVEL_PRO)),
		new/datum/stack_recipe("black multi-tile airlock assembly", /obj/structure/door_assembly/multi_tile/stalker3, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE, required_skills = list(/datum/skill/construction = SKILL_LEVEL_PRO)),
		new/datum/stack_recipe("red airlock assembly", /obj/structure/door_assembly/door_assembly_red, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE, required_skills = list(/datum/skill/construction = SKILL_LEVEL_PRO)),
		new/datum/stack_recipe("blue airlock assembly", /obj/structure/door_assembly/door_assembly_blue, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE, required_skills = list(/datum/skill/construction = SKILL_LEVEL_PRO)),
		new/datum/stack_recipe("yellow airlock assembly", /obj/structure/door_assembly/door_assembly_yellow, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE, required_skills = list(/datum/skill/construction = SKILL_LEVEL_PRO)),
		new/datum/stack_recipe("grey airlock assembly", /obj/structure/door_assembly/door_assembly_grey, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE, required_skills = list(/datum/skill/construction = SKILL_LEVEL_PRO)),
		new/datum/stack_recipe("fresh airlock assembly", /obj/structure/door_assembly/door_assembly_fresh, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE, required_skills = list(/datum/skill/construction = SKILL_LEVEL_PRO)),
		new/datum/stack_recipe("rainbow airlock assembly", /obj/structure/door_assembly/door_assembly_rainbow, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE, required_skills = list(/datum/skill/construction = SKILL_LEVEL_PRO)),
		), 4),
	null,
